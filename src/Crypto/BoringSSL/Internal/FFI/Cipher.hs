...
foreign import ccall unsafe "EVP_aes_128_cbc"
  c_EVP_aes_128_cbc :: Ptr EVP_CIPHER

-- | const EVP_CIPHER *EVP_aes_256_cbc(void)
foreign import ccall unsafe "EVP_aes_256_cbc"
  c_EVP_aes_256_cbc :: Ptr EVP_CIPHER

-- | const EVP_CIPHER *EVP_aes_128_ctr(void)
foreign import ccall unsafe "EVP_aes_128_ctr"
...
foreign import ccall unsafe "EVP_EncryptUpdate_ex"
...
--                            size_t max_out_len)
foreign import ccall unsafe "EVP_EncryptFinal_ex2"
...
--                            size_t max_out_len, const uint8_t *in, size_t in_len)
foreign import ccall unsafe "EVP_DecryptUpdate_ex"
...
--                            size_t max_out_len)
foreign import ccall unsafe "EVP_DecryptFinal_ex2"
