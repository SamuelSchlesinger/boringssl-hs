...
foreign import ccall unsafe "SHA384"
...
foreign import ccall unsafe "SHA512_256"
...
foreign import ccall unsafe "EVP_sha224"
  c_EVP_sha224 :: Ptr EVP_MD

-- | const EVP_MD *EVP_sha256(void)
foreign import ccall unsafe "EVP_sha256"
  c_EVP_sha256 :: Ptr EVP_MD

-- | const EVP_MD *EVP_sha384(void)
foreign import ccall unsafe "EVP_sha384"
  c_EVP_sha384 :: Ptr EVP_MD

-- | const EVP_MD *EVP_sha512(void)
foreign import ccall unsafe "EVP_sha512"
  c_EVP_sha512 :: Ptr EVP_MD

-- | const EVP_MD *EVP_sha512_256(void)
foreign import ccall unsafe "EVP_sha512_256"
...
foreign import ccall unsafe "EVP_DigestInit_ex"
