...
foreign import capi unsafe "openssl/curve25519.h ED25519_keypair"
...
foreign import capi safe "openssl/curve25519.h ED25519_sign"
  c_ED25519_sign :: Ptr CUChar -> Ptr CUChar -> CSize -> Ptr CUChar -> IO CInt

-- | int ED25519_verify(const uint8_t *message, size_t message_len,
--                      const uint8_t signature[64], const uint8_t public_key[32])
foreign import capi safe "openssl/curve25519.h ED25519_verify"
  c_ED25519_verify :: Ptr CUChar -> CSize -> Ptr CUChar -> Ptr CUChar -> IO CInt

-- | void ED25519_keypair_from_seed(uint8_t out_public_key[32],
--                                  uint8_t out_private_key[64],
--                                  const uint8_t seed[32])
foreign import capi unsafe "openssl/curve25519.h ED25519_keypair_from_seed"
