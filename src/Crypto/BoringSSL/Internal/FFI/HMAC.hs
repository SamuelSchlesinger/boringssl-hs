...
foreign import capi unsafe "openssl/hmac.h HMAC_CTX_new"
  c_HMAC_CTX_new :: IO (Ptr HMAC_CTX)

-- | void HMAC_CTX_free(HMAC_CTX *ctx)
foreign import capi unsafe "openssl/hmac.h HMAC_CTX_free"
...
foreign import capi unsafe "openssl/hmac.h HMAC_Init_ex"
