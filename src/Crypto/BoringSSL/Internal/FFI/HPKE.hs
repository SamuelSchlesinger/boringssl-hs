...
foreign import capi safe "openssl/hpke.h EVP_HPKE_KEY_generate"
...
foreign import capi unsafe "openssl/hpke.h EVP_HPKE_KEY_init"
...
foreign import capi unsafe "openssl/hpke.h EVP_HPKE_KEY_public_key"
...
--                                size_t *out_len, size_t max_out)
foreign import capi unsafe "openssl/hpke.h EVP_HPKE_KEY_private_key"
...
foreign import capi unsafe "openssl/hpke.h EVP_HPKE_CTX_new"
  c_EVP_HPKE_CTX_new :: IO (Ptr EVP_HPKE_CTX)

-- | void EVP_HPKE_CTX_free(EVP_HPKE_CTX *ctx)
foreign import capi unsafe "openssl/hpke.h EVP_HPKE_CTX_free"
...
foreign import capi safe "openssl/hpke.h EVP_HPKE_CTX_setup_sender"
  c_EVP_HPKE_CTX_setup_sender
...
foreign import capi safe "openssl/hpke.h EVP_HPKE_CTX_setup_recipient"
  c_EVP_HPKE_CTX_setup_recipient
...
foreign import capi safe "openssl/hpke.h EVP_HPKE_CTX_setup_auth_sender"
  c_EVP_HPKE_CTX_setup_auth_sender
    :: Ptr EVP_HPKE_CTX -> Ptr CUChar -> Ptr CSize -> CSize
...
foreign import capi safe "openssl/hpke.h EVP_HPKE_CTX_setup_auth_recipient"
  c_EVP_HPKE_CTX_setup_auth_recipient
    :: Ptr EVP_HPKE_CTX -> Ptr EVP_HPKE_KEY -> Ptr EVP_HPKE_KDF
    -> Ptr EVP_HPKE_AEAD -> Ptr CUChar -> CSize
    -> Ptr CUChar -> CSize
...
foreign import capi safe "openssl/hpke.h EVP_HPKE_CTX_seal"
  c_EVP_HPKE_CTX_seal
    :: Ptr EVP_HPKE_CTX -> Ptr CUChar -> Ptr CSize -> CSize
