...
-- | RSA *RSA_new(void)
foreign import capi unsafe "openssl/rsa.h RSA_new"
...
foreign import capi safe "openssl/rsa.h RSA_generate_key_ex"
...
foreign import capi unsafe "openssl/rsa.h RSA_bits"
...
foreign import capi safe "openssl/rsa.h RSA_sign"
...
foreign import capi safe "openssl/rsa.h RSA_verify"
...
foreign import capi safe "openssl/rsa.h RSA_sign_pss_mgf1"
...
foreign import capi safe "openssl/rsa.h RSA_verify_pss_mgf1"
...
foreign import capi safe "openssl/rsa.h RSA_encrypt"
  c_RSA_encrypt :: Ptr RSA_C -> Ptr CSize -> Ptr CUChar -> CSize
                -> Ptr CUChar -> CSize -> CInt -> IO CInt

-- | int RSA_decrypt(RSA *rsa, size_t *out_len, uint8_t *out, size_t max_out,
--                   const uint8_t *in, size_t in_len, int padding)
foreign import capi safe "openssl/rsa.h RSA_decrypt"
...
foreign import capi unsafe "openssl/rsa.h RSA_public_key_to_bytes"
