...
foreign import ccall unsafe "TRUST_TOKEN_CLIENT_new"
...
foreign import ccall unsafe "TRUST_TOKEN_CLIENT_add_key"
  c_TRUST_TOKEN_CLIENT_add_key
...
foreign import ccall unsafe "TRUST_TOKEN_CLIENT_begin_issuance"
  c_TRUST_TOKEN_CLIENT_begin_issuance
...
foreign import ccall unsafe "TRUST_TOKEN_CLIENT_finish_issuance"
  c_TRUST_TOKEN_CLIENT_finish_issuance
...
--     uint64_t time)
foreign import ccall unsafe "TRUST_TOKEN_CLIENT_begin_redemption"
  c_TRUST_TOKEN_CLIENT_begin_redemption
...
--     const uint8_t *response, size_t response_len)
foreign import ccall unsafe "TRUST_TOKEN_CLIENT_finish_redemption"
  c_TRUST_TOKEN_CLIENT_finish_redemption
    :: Ptr TRUST_TOKEN_CLIENT -> Ptr (Ptr CUChar) -> Ptr CSize
...
--     const TRUST_TOKEN_METHOD *method, size_t max_batchsize)
foreign import ccall unsafe "TRUST_TOKEN_ISSUER_new"
...
foreign import ccall unsafe "TRUST_TOKEN_ISSUER_add_key"
  c_TRUST_TOKEN_ISSUER_add_key
...
foreign import ccall unsafe "TRUST_TOKEN_ISSUER_set_metadata_key"
  c_TRUST_TOKEN_ISSUER_set_metadata_key
    :: Ptr TRUST_TOKEN_ISSUER -> Ptr CUChar -> CSize -> IO CInt
...
foreign import ccall unsafe "boringssl_sk_TRUST_TOKEN_num"
...
foreign import ccall unsafe "boringssl_sk_TRUST_TOKEN_value"
