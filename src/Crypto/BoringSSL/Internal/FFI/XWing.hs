...
foreign import ccall unsafe "XWING_generate_key"
  c_XWING_generate_key
...
foreign import ccall unsafe "XWING_public_from_private"
  c_XWING_public_from_private
    :: Ptr CUChar              -- out_encoded_public_key
...
foreign import ccall unsafe "XWING_encap"
  c_XWING_encap
...
--     const struct XWING_private_key *private_key)
foreign import ccall unsafe "XWING_decap"
  c_XWING_decap
    :: Ptr CUChar              -- out_shared_secret
